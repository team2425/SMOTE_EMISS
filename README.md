...
Dataset_bal_emission/
│
├── balanced_smote.csv
├── final_balanced_dataset.csv
├── test_dataset.csv
├── original_class_stats.csv
├── duplicate_comparison.csv
├── balancing_techniques_comparison.csv
│
├── balancing_summary_report.md
│
├── Figures/
│ ├── original_class_distribution.png
│ ├── smote_class_distribution.png
│ ├── balancing_methods_comparison.png
│ ├── SMOTE_feature_space_analysis.png
